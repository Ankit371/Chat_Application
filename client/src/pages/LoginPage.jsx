      ...
      <form onSubmit={onSubmitHandler} action="" className='border-2 bg-white/8 text-white border-gray-500 p-6 flex
       flex-col gap-6 rounded-lg shadow-lg'>
        ...
        <h2 className='font-medium text-2xl flex justify-between items-center'>
          {currState}
          {isDataSubmit &&
          <img onClick={()=>setIsDataSubmit(false)} src={assets.arrow_icon} alt="" className='w-5 cursor-pointer' />
           }
          </h2>
          ...
          {!isDataSubmit && (
            ...
            focus:ring-indigo-500' />
             ...
             type="password" placeholder='Enter your password' required className='p-2 
            border border-gray-500 rounded-md focus:outline-none focus:ring-2 
            focus:ring-indigo-500' />
            </>
          )}
          {
            ...
            border border-gray-500 rounded-md focus:outline-none focus:ring-2 
            focus:ring-indigo-50' placeholder='Provide a short bio...'></textarea>
            )
          }
          ...
          <div className='flex flex-col gap-2'>
            {currState === "Sign up" ? (
              <p className='text-sm text-gray-600'>Already have an Account
               ...
               onClick={()=>{setCurrState("Login"); setIsDataSubmit(false)}}>Login Here</span></p>
            ):(
