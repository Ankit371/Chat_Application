...
useEffect(()=>{
  ...
  <button 
    ...
    className="hidden md:block text-gray-400 hover:text-red-400"
  >
    ✖
  </button>
      ...
      <div className=' flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
        {messages.map((msg, idx)=>(
          <div key={idx} className={`flex items-end gap-2 justify-end ${msg.senderId !== 
       ...
       {/* botoom area for user */}

        <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 '> 
            <div className='flex-1 items-center bg-gray-100/12 px-3 rounded-full '>
    ...
    bg-white/10 max-md:hidden '>
      <img src={assets.help_icon} alt="" className='max-w-16'/>
